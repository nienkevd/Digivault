...
//    public ResponseEntity<FinancieelOverzicht> overzichtHanlder(@RequestBody FinancieelOverzichtDto
//                                                                               financieelOverzichtDto) {
//        return ResponseEntity.ok().body(financieelOverzicht);
//    }
}
